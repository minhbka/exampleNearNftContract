...
let Contract = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = call({}), _dec4 = view(), _dec5 = view(), _dec6 = view(), _dec7 = call({}), _dec8 = call({}), _dec9 = call({}), _dec(_class = (_class2 = class Contract {
  constructor() {
    this.token_id = 0;
    this.owner_id = "";
  ...
  nft_transfer_call({
    ...
    log(`nft_transfer_call called, receiver_id ${to}, token_id ${token_id}`);
    let from = predecessorAccountId();
    let old_owner = this.internal_transfer({
      from,
      to,
      token_id,
      approval_id,
    ...
    promiseBatchActionFunctionCall(promise, "nft_on_transfer", JSON.stringify({
      sender_id: from,
      previous_owner_id: old_owner,
      token_id: token_id,
      msg
    }), 0, 30000000000000);
    promiseThen(promise, currentAccountId(), "nft_resolve_transfer", JSON.stringify({
      previous_owner_id: old_owner,
      to,
      token_id
    }), 0, 30000000000000);
  ...
  nft_resolve_transfer({
    ...
    log(`nft_resolve_transfer called, receiver_id ${receiver_id}, token_id ${token_id}`);
    const is_token_transfered = JSON.parse(promiseResult(0));
    log(`NFT with id: ${token_id} ${is_token_transfered ? "was transfered" : "was not transfered"}`);
    if (!is_token_transfered) {
      ...
      if (current_owner === receiver_id) {
        ...
        log(`${token_id} returned to ${previous_owner_id}`);
        return;
      }
      log(`Failed to return token ${token_id}. It was burned or not owned by ${receiver_id} now.`);
    }
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "mint_nft", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "mint_nft"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_token_by_id", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "get_token_by_id"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_supply_tokens", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "get_supply_tokens"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_all_token", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "get_all_token"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_transfer", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_transfer"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_transfer_call", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_transfer_call"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_resolve_transfer", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_resolve_transfer"), _class2.prototype)), _class2)) || _class);
...
function get_all_token() {
  ...
  const _args = Contract._getArgs();
  const _result = _contract.get_all_token(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result, true));
}
...
export { get_all_token, get_supply_tokens, get_token_by_id, init, mint_nft, nft_resolve_transfer, nft_transfer, nft_transfer_call };
//# sourceMappingURL=contract-no-frontend.js.map
